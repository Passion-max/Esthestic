                ...
                <div className="slider-inner style-2 home-2 flex">
                  <div className="slider-content">
                    <h1 className="heading">
                      Unearth and Own Exclusive Digital NFTs
                    </h1>
                    <p className="sub-heading">
                      Embark on a journey of discovery through our vast digital
                      landscape. Seize the opportunity to claim exclusive
                      digital assets as your own, enriching your portfolio with
                      unique pieces of digital art, music, and more.
                    </p>
            ...
            <div className="slider-item">
              <div className="slider-inner home-2 flex">
                <div className="slider-content">
                  ...
                  <p className="sub-heading">
                    Embark on a journey of discovery through our vast digital
                    landscape. Seize the opportunity to claim exclusive digital
                    assets as your own, enriching your portfolio with unique
                    pieces of digital art, music, and more.
                  </p>
